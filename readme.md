...
Живой журнал для публикации статей.

Возможность добавлять видео и фото контент, добавлять комментарии, осуществлять поиск по статьям, задавать категории и производить настройки через веб-панель.

Архитектура и технологии: 
- Frontend Nodejs (шаблонизатор pug, сервер express, веб сокеты socket.io)
- Backend Nodejs (сервер express, ORM sequelize)
- БД PostgreSQL в докере, для тестов SQLIte in memory
- Тестирование e2e (jest)
